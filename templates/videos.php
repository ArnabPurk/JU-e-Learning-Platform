...
$n = 0;
$query11 = "select m_id,video from course natural join study_material natural join records  where c_id='$cid'";
        ...
        <div class="row1">
          ...
          <?php for ($i = 0; $i < $n; $i++) { ?>
            ...
            <div class="image1" style="text-align:center;">
              <!-- <img src="1.jpg" alt=""> -->
              <div class="details1">
                <h2><span><?php echo str_replace("study_materials/records/" . $xd, "", $videos1[$i]); ?></span></h2>
                <div class="more1">
                  <a href="videodetails.php?m_id=<?php if (isset($viid[$i])) echo $viid[$i]; ?>" class="read-more1"><span>Watch or Download</span></a>
                </div>
              </div>
            </div>
            <!--image card end-->
