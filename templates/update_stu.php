...
<head>
   ...
   // $password = md5($row['password']);
    ...
    if(isset($_POST['ddd']))
    {
        $q="delete from payment where u_id='$uid'";
        mysqli_query($con, $q);
        $q="delete from takes_part where u_id='$uid'";
        mysqli_query($con, $q);
        $q="delete from enroll where u_id='$uid'";
        mysqli_query($con, $q);
        $q="delete from student where u_id='$uid'";
        mysqli_query($con, $q);
...
<div class="containerr">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="user-details">
                ...
                <img src="<?php if (isset($dp)) echo $dp; ?>" alt="Your Profile Picture" style="object-fit: cover;margin:2rem 0rem;margin-left:23.3rem;" height="300" width="300">
