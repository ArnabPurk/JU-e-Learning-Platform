            ...
            <div class="container">
                ...
                <div class="row1">
                    ...
                    <?php for ($i = 0; $i < $n; $i++) {
                        $gh = $eid[$n - $i - 1]; ?>
                        <?php
                        $query11 = "select * from takes_part where e_id='$gh' and u_id='$uid'";
                        $result11 = mysqli_query($con, $query11);
                        ...
                        <div class="image1" style="text-align:center;">
                            ...
                            <div class="details1">
                                ...
                                <div class="more1">
                                    <a href="exam_stu_details.php?e_id=<?php echo $eid[$n - $i - 1]; ?>" class="read-more1"><span>More</span><span style="margin-left:5rem;"><span style="color:blue;"><?php echo $mark; ?></span>/<?php echo $grade[$n - $i - 1]; ?></span></a>
                                </div>
                            </div>
                        </div>
                        <!--image card end-->
