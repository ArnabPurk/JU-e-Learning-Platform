...
$n = 0;
$query11 = "select m_id,slide from course natural join study_material natural join slides  where c_id='$cid'";
...
<body>
  ...
  <div class="vertical-nav bg-white" id="sidebar">
    ...
    <ul class="nav flex-column bg-white mb-0">
      <li class="nav-item">
        <a href="slides.php" class="nav-link text-dark bg-light">
        ...
        <div class="row1">
          ...
          <?php for ($i = 0; $i < $n; $i++) { ?>
            ...
            <div class="image1" style="text-align:center;">
              <!-- <img src="1.jpg" alt=""> -->
              <div class="details1">
                <h2><span><?php echo str_replace("study_materials/slides/" . $xd, "", $slides1[$i]); ?></span></h2>
                <div class="more1">
                  <a href="<?php echo $slides[$i] ?>" class="read-more1" download><span>Download</span></a>
                </div>
              </div>
            </div>
            <!--image card end-->
