...
$title = $class_data['cname'];
$cstatus = $class_data['cstatus'];

if (isset($_POST['upload'])) {
    $progress = $_POST['progress'];
    $st = "update course set cstatus='$progress' where c_id='$cid'";
    mysqli_query($con, $st);
    echo "<script>location.href = 'progress_tea.php';</script>";
}
?>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <div class="vertical-nav bg-white" id="sidebar">
        ...
        <ul class="nav flex-column bg-white mb-0">
            ...
            <li class="nav-item">
                <a href="progress_tea.php" class="nav-link text-dark bg-light">
    ...
    <div class="page-content p-5" id="content">
        ...
        <div class="col-lg-12 py-2">
            <h4 class="text-uppercase"><?php if ($id == "Teacher") {
                                            echo "Update your course progress";
                                        } else {
                                            echo "Course Progress";
                                        } ?></h4>
            <form method="post" enctype="multipart/form-data" style="display:<?php if ($id == "Teacher") {
                                                                                    echo "block";
                                                                                } else {
                                                                                    echo "none";
                                                                                } ?>">
                <input type="range" id="myRange" name="progress" value="<?php echo $cstatus; ?>" max="100" style="width:30rem;">
                <div id="rangeValue"><?php echo $cstatus; ?></div>
                <button class="btn btn-secondary" name="upload" style="margin-top:1rem;">Submit</button>
            </form>
            <div class="progress progress-striped active" style="width:20rem;margin-left:30%;height:20rem;border-radius: 50%;margin-top:<?php if ($id == "Teacher") {
                                                                                                                                            echo "-3rem";
                                                                                                                                        } else {
                                                                                                                                            echo "2rem";
                                                                                                                                        } ?>;">
                <div class="progress-bar bg-warning progress-bar-success progress-bar-animated" style="width: 0%;">
                    <h5><?php echo $cstatus; ?>%</h5>
                </div>
            </div>
